...
First, the MO Codes were formatting as a string, like "3036 3004 3026 3101 4003". Each of these codes means that a certain circumstance was present in the accident. For example "3036" means that the accident occurred at an intersection. The first step data cleaning step was to translate these codes into useful binary variables, defined in columns in the data frame. For example, if a pedestrian was involved in the collision it would be coded as "3036" or "3501", based on the MO Codes information. So if either of those values were present in the MO Codes string, the new column "Pedestrian_involved" would take a value of 1, otherwise it would be coded as a 0. I coded as many independent variables as seemed relevant to be useful in predicting the severity of the outcome of the collision. The outcomes "No_injury", "Severe_injury", "Fatality", and "Other_injury" were also coded as new columns using the MO Codes data, and those variables will be considered the dependent variables in this analysis. 
